    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <div className="flex items-center justify-center gap-2 mb-4">
          <Logo size={32} />
          <span className="text-3xl font-bold text-slate-800">SkinWise</span>
        </div>
      ...
      <div className="card mb-8">
        ...
        <div className="prose text-slate-600 space-y-3 text-sm leading-relaxed">
          <p>SkinWise was born out of frustration — the frustration of scrolling through skincare Reddit threads at midnight, trying to figure out if niacinamide and vitamin C can be used together (they can), or whether salicylic acid is right for your combination skin (it probably is).</p>
      ...
      <div className="card bg-blue-50 border border-blue-100 text-center">
        ...
        <p className="text-sm text-blue-700">
          SkinWise is an educational platform, not a medical service. The information provided is for general educational purposes only and does not constitute medical advice. Always consult a qualified dermatologist for diagnosis and treatment of skin conditions.
        </p>
      </div>
